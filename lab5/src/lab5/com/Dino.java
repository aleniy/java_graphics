...
public class Dino extends JFrame {
    ...
    private void addImageBackground() {
    	TextureLoader t = new TextureLoader("D:\\универ(люблю ѕ»)\\3 курс\\Comp_gr\\lab5\\source_folder\\123.png", canvas);
    ...
    private TransformGroup getStegoGroup() throws IOException {
    	Shape3D shape = getModelShape3D("polysurface164", "D:\\универ(люблю ѕ»)\\3 курс\\Comp_gr\\lab5\\source_folder\\dinosaur.obj");
